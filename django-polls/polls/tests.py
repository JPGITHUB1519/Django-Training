...
def create_question(question_text, days):
	...
	# Model.objects.create -> create and save an object in the same time
	return Question.objects.create(question_text=question_text, pub_date=time)

class QuestionViewTests(TestCase):
	def test_index_view_with_no_question(self):
		"""
			If not Question Exits, an appropiate message should be displayed
		"""
	...
	def test_index_view_with_a_future_question(self):
		"""
			Question with a pub_date in the future should no be displayed 
			on the index page
		"""
	...
	def text_index_view_with_future_question_and_past_question(self):
		"""
			Even if both past future question exits, only past questions
			should be displayed
		"""
		create_question(question_text="Past Question.", days=-30)
